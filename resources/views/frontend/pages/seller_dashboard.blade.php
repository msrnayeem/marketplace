...
<div class="container">
    <div class="row">
            ...
            <div class="card border-0 mb-4" style="border-radius: 0;">
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col">
                            <!-- Column 1: Image -->
                            <img src="{{ asset($seller->avatar) }}" alt="User 1" class="avatar" style="max-height: 40px;">
                        </div>
                        <div class="col p-0">
                            <!-- Column 2: Name -->
                            <p>{{ $seller->name }}</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 p-0">
                            <div class="progress mt-1">
                                ...
                                aria-label="Example with label" style="width: 25%;" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 p-0">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" 
                                aria-label="Example" style="width: 25%;" aria-valuenow="25"
        ...
        <div class="col-md-8 p-3">
            ...
            <div class="row">
                <div class="card border-0 mb-4" style="border-radius: 0;">               
                    <div class="card-body d-flex align-items-center justify-content-between p-2">
                        <div>
                            <p class="mb-0">Active Orders - 5</p>
                        </div>
                        <div>
            ...
            <!-- carousel start -->
            <div class="row">
                <div id="carouselExampleCaptions" class="carousel slide p-0" data-bs-ride="carousel" style="min-width:100%;">
