                ...
                <div class="info-container border-1">
                    ...
                    <div class="info active" id="basic-tab-info">
                      <form method="post" action="{{ route('orders.store') }}">
                        ...
                        <input type="hidden" name="package_id" value="{{ $gig->gigPackages[0]->id }}" id="package">
                        <div class="mt-3 border-1 text-center">
                            <button class="btn btn-dark order-button" id="order" style="width:100%;">Order Now</button>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="info" id="standard-tab-info">
                      <form method="post" action="{{ route('orders.store') }}">
                        ...
                        <input type="hidden" name="gig_id" value="{{ $gig->id }}" id="gig_id">
                        <input type="hidden" name="package_id" value="{{ $gig->gigPackages[1]->id }}" id="package">
                        <div class="mt-3 border-1 text-center">
                    ...
                    <div class="info" id="premium-tab-info">
                      <form method="post" action="{{ route('orders.store') }}">
                        ...
                        <input type="hidden" name="gig_id" value="{{ $gig->id }}" id="gig_id">
                        <input type="hidden" name="package_id" value="{{ $gig->gigPackages[2]->id }}" id="package">
                        <div class="mt-3 border-1 text-center">
                            <button class="btn btn-dark order-button" style="width:100%;">Order Now</button>
                        </div>
                      </form>
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            error: function (error) {
              console.error('Error placing order:', error.responseJSON.message);
              Swal.fire({
