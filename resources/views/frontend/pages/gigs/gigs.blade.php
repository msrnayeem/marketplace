...
@section('content')
            ...
            <ol class="breadcrumb">
                ...
                @if ($gigs->isNotEmpty())
                    <li class="breadcrumb-item active" aria-current="page">
                        <a
                            href="{{ route('categories.show', ['category' => $gigs[0]->subSubCategory->subCategory->category->key]) }}">
    ...
    <div class="container mt-2 p-0">
        ...
        <div class="row">
            @if ($gigs->isNotEmpty())
                @foreach ($gigs as $gig)
                    <div class="col-md-4 col-sm-12 col-xl-2 mb-2 p-4">
                        <div class="card border-0">
                            ...
                            <div class="row align-items-center p-1">
                                <div class="col-2">
                                    ...
                                    <img src="{{ asset($gig->user->avatar) }}" alt="seller"
